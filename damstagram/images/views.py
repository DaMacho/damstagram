...
class Search(APIView):
    ...
    def get(self, request, format=None):
        ...
        if hashtags is not None:
            ...
            # filter images containing components in hashtags(list) in their tags, 
            # and only filter uniques 
...
class ImageDetail(APIView):
    ...
    def put(self, request, image_id, format=None):
        ...
        if serializer.is_valid():
            ...
            return Response(data=serializer.data.errors, status=status.HTTP_400_BAD_REQUEST)
