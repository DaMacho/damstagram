...
MIGRATION_MODULES = {
    'sites': 'damstagram.contrib.sites.migrations'
}
...
# TODO : Changed to False cuz of testing post request. Need to change to True in future
...
# https://django-allauth.readthedocs.io/en/latest/configuration.html
SOCIALACCOUNT_ADAPTER = 'damstagram.users.adapters.SocialAccountAdapter'
...
# applied because the token expire too soon.
JWT_AUTH = {
...
REST_AUTH_REGISTER_SERIALIZERS = {
    'REGISTER_SERIALIZER': 'damstagram.users.serializers.SignUpSerializer'
}